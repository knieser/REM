function [est_gmm,est_gmm_2, weights, est_gamma, opt_eps] = LPA_Sims(sim, k_choice, delta)
% Sim Key
% 1 = No corruption
...
[est_gmm, est_gmm_2, est_weights, est_gamma, opt_eps] = LPA_sim_main(X, k_choice, global_iter,delta,step,seed);

% Add flag for minority group;
minority = [grp_flag grp_flag > k_choice];
